            ...
            <div class="page-title-box">
                <div class="float-end">
                    <ol class="breadcrumb">
                        ...
                        <!--end nav-item-->
                        <li class="breadcrumb-item"><a href="#">Edit Game</a>
                        </li>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="link_game" id="link_game"
                                    placeholder="Masukan Link Game" value="{{ $item->link_game }}" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="file" name="cover" id="cover"
                                    placeholder="Masukan Cover Game">
                                <a href="{{ asset('backend/images/cover/' . $item->cover) }}"
                                    class="btn btn-primary mt-3" target="_blank">Lihat
                                    Cover</a>
                            </div>
                        </div>
