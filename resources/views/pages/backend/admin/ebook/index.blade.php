...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="float-end">
                    <ol class="breadcrumb">
                        ...
                        <!--end nav-item-->
                        <li class="breadcrumb-item"><a href="#">Ebook</a>
                        </li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('ebook.create') }}" class="btn btn-primary"><i class="mdi mdi-plus-circle"></i>
                        Tambah Data
                    </a>
                        ...
                        <table class="table" id="table-datatables">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ asset('backend/images/file/' . $item->file) }}" title="Show"
                                            target="_blank" class="btn btn-info btn-sm"><i
                                                class="mdi mdi-eye-circle"></i>
                                        </a>
                                        <a href="{{ route('ebook.edit', $item->id) }}" title="Edit"
                                            class="btn btn-warning btn-sm"><i class="mdi mdi-square-edit-outline"></i>
                                        </a>

                                        <form class="d-inline" action="{{ route('ebook.destroy', $item->id) }}"
