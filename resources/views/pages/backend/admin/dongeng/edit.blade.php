            ...
            <div class="page-title-box">
                <div class="float-end">
                    <ol class="breadcrumb">
                        ...
                        <!--end nav-item-->
                        <li class="breadcrumb-item"><a href="#">Edit Dongeng</a>
                        </li>

                    </ol>
                </div>
                <h4 class="page-title">Edit Dongeng</h4>
            </div>
            <!--end page-title-box-->
        </div>
        <!--end col-->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('dongeng.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="mb-3 row">
                            <label for="judul" class="col-sm-2 col-form-label">Judul Dongeng</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" value="{{ $item->judul }}" name="judul"
